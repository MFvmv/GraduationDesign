...
/**
 * 默认的 FinancialrecordsInpatientsRelation 对象
 */
export const Fields = {
    transactionID: null, // 财务记录唯一标识（外键）
    inpatientID: null, // 住院唯一标识（外键）
};
...
export const FieldsName = {
    ...
    inpatientID: "住院唯一标识（外键）",
}

export const PrimaryKey = "inpatientID";

/**
 * 获取 FinancialrecordsInpatientsRelation 列表
 */
const standardURL = "/RESTful/standard/financialrecordsInpatientsRelation";
const readerURL = "/RESTful/reader/financialrecordsInpatientsRelation";
...
/**
 * 添加 FinancialrecordsInpatientsRelation
 */
export function create(data) {
    if(!haveSameKeys(data,Fields)){
        throw new Error("FinancialrecordsInpatientsRelation的create请求数据结构不一致！");
    }
...
/**
 * 更新 FinancialrecordsInpatientsRelation
 */
export function update(id,data) {
    if(id===undefined || data===undefined) throw Error("必填参数未传入");
    if(!haveSameKeys(data,Fields)){
        throw new Error("FinancialrecordsInpatientsRelation的update请求数据结构不一致！");
    }
    return request({
        url: standardURL+"/"+id,
        method: 'put',
...
/**
 * 删除 FinancialrecordsInpatientsRelation
 */
