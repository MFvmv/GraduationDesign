package com.hospital.externalservice.controller;


import com.hospital.common.api.CommonResult;
import com.hospital.externalservice.configuration.AlipayConfig;
import com.hospital.externalservice.domain.AliPayParam;
import com.hospital.externalservice.service.AlipayService;
...
public class AlipayController {
    ...
    public CommonResult<String> query(String outTradeNo, String tradeNo){
        String reslut = alipayService.query(outTradeNo,tradeNo);
        if(reslut == null) return CommonResult.failed();
